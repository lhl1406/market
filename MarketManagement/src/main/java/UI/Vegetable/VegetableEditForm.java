...
import UI.Category.CategoryEditForm;
...
public class VegetableEditForm extends javax.swing.JFrame {
    ...
    public VegetableEditForm() {
        this.setTitle("Edit Vegetable");
        initComponents();
        loadCombobox();
    }

    public VegetableEditForm(int vegetableID, VegetableForm parent, boolean modal) throws SQLException {
        this.setTitle("Edit Vegetable");
        initComponents();
        loadCombobox();
        this.setLocationRelativeTo(null);
        veg = vegBLL.getVegetable(vegetableID);
        home = parent;
        getInfor();
    }

    public void getInfor() {
        cbCateID.setSelectedItem(veg.getCatagory().CatagoryID);
        txtVegetableName.setText(veg.getVegetableName());
        txtUnit.setText(veg.getUnit());
        txtAmount.setText(String.valueOf(veg.getAmount()));
        txtPrice.setText(String.valueOf(veg.getPrice()));
        txtLinkImage.setText(veg.getImage());
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("EDIT VEGETABLE");
        ...
        cbCateID.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "CateID", "1", "1", "1", "1", "1", "1" }));
                    ...
                    .addGroup(panel1Layout.createSequentialGroup()
                        ...
                        .addGroup(panel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(panel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(txtVegetableName, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                ...
                                .addComponent(cbCateID, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))))
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        if (txtAmount.getText().equals("")
            ...
            veg.setCatagory(cate);

            veg.setVegetableName(txtVegetableName.getText());
            veg.setUnit(txtUnit.getText());
            veg.setAmount(Integer.parseInt(txtAmount.getText()));
            veg.setImage(txtLinkImage.getText());
            Double price = Double.parseDouble(txtPrice.getText());
            veg.setPrice(price);

            try {
                int choice = JOptionPane.showConfirmDialog(null, "Do you want to update this Vegetable?", "Warning!", JOptionPane.YES_NO_OPTION);
                if (choice == JOptionPane.NO_OPTION) {
                    return;
                } else {
                    if (vegBLL.updateVegetable(veg) > 0) {
                        JOptionPane.showMessageDialog(this, "You have completed to update Vegetable successfully!", "Message", JOptionPane.PLAIN_MESSAGE);
                        home.initTable();
                    }
                }
            } catch (SQLException ex) {
                Logger.getLogger(VegetableEditForm.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VegetableEditForm().setVisible(true);
            }
        });
    }
