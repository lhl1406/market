...
public class CustomerAddForm extends javax.swing.JFrame {
    ...
    public CustomerAddForm() {
        ...
        home = new CustomerForm();
        initComponents();
        
        int lastID=cusBLL.getLastID();
        int newID=lastID+1;
        txtCus.setText(String.valueOf(newID));
    }
     ...
     */
    public CustomerAddForm(CustomerForm parent ,boolean  modal) {
        this.setTitle("Add Customer");
        initComponents();
        closeChidrentForm(parent, modal);
    }
     public void closeChidrentForm(CustomerForm parent, boolean  modal) {
    ...
    private void btnSaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSaveMouseClicked
        ...
        try {
            ...
            if (cusBLL.addCustomer(cus) > 0) {
                JOptionPane.showMessageDialog(this, "You have completed to add Customer successfully!", "Message", JOptionPane.PLAIN_MESSAGE);
                home.initTable();
            }
        } catch (SQLException ex) {
            Logger.getLogger(CustomerAddForm.class.getName()).log(Level.SEVERE, null, ex);
        }                                       
